...
class User {
    ...
    //User registerAccount = new User();
    //User adminAccount = new User("Pan", "user01");
    ...
    public void loginPage() {
        ...
        do {
            ...
            switch (option) {
                case '1':
                    User registerAccount = new User();
                    registerAccount.userRegister();
                    break;

                case '2':
                    User adminAccount = new User("Pan", "user01");
                    adminAccount.userMenu();
                    break;
    ...
    public void userRegister() {
        ...
        System.out.println("Set up your user password: ");
        studentPassword = sc.nextLine();
        userPassword.add(studentPassword);
